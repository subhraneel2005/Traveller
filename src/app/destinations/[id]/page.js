  ...
  throw new Error("Stripe publishable key is not defined")
    ...
    const destinations = [
        ...
        },
        {
          ...
          image: '/img3.jpeg',
          about: 'Urban Adventure invites you to dive into the bustling life of world-renowned cities, featuring iconic landmarks, diverse culinary scenes, and dynamic nightlife. Explore skyscrapers, parks, and cultural institutions. Sample cuisine from street food vendors to Michelin-starred restaurants. Discover the pulse of the city through music, theater, and art galleries. Its an ideal destination for those who thrive in fast-paced environments and love exploring new urban landscapes.',
          amount: 14990
        },
        {
          id: 4,
        ...
        <div className="max-w-6xl mx-auto mb-12 text-center">
          ...
          <div className="flex justify-center">
            ...
            <Elements stripe={stripePromise}
              options={{
                mode: "payment",
                amount:convertToSubCurrency(destination.amount),
                currency: "usd"
              }}
            >
